    ...
    // JSX return statement rendering the Countdown UI
        ...
        return (
            <div>
                ...
                <div className="flex flex-col items-center justify-center pt-6 bg-gray-100 dark:bg-gray-900">
                    {/* Timer box container */}
                    <div className="bg-white dark:bg-gray-800 shadow-lg shadow-blue-300 rounded-lg p-8 w-full max-w-md">
                        ...
                        <div className="flex justify-center  gap-4">
                            <Button
                                onClick={handleStart}
                                variant="outline"
                                className="text-gray-100 dark:text-gray-200 bg-gray-800"
                            >
